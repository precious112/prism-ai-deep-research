...
export const chatApi = {
  ...
  sendMessage: async (chatId: string, content: string, model?: string, provider?: string, includeIllustrations: boolean = true, apiKey?: string, serperApiKey?: string, tavilyApiKey?: string) => {
    const response = await api.post<ApiResponse<{ message: Message }>>(`/chats/${chatId}/messages`, { content, model, provider, includeIllustrations, apiKey, serperApiKey, tavilyApiKey });
